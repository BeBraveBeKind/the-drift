-- Combined Migration Script for Critical Foundations (Supabase Compatible)
...
ADD COLUMN IF NOT EXISTS town_id uuid REFERENCES towns(id) ON DELETE RESTRICT;
...
ALTER TABLE locations DROP CONSTRAINT IF EXISTS locations_slug_town_unique;
