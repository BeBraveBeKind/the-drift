...
export default function Navigation() {
  ...
  return (
    <nav className="bg-white border-b-2 border-[#2C2C2C] sticky top-0 z-50 shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between items-center h-16">
          {/* Logo */}
          <Link href="/" className="font-bold text-xl text-[#2C2C2C] hover:text-[#000000] transition-colors">
            📌 Switchboard
          </Link>
          ...
          <button
            ...
            className="p-2 hover:bg-gray-100 rounded-lg transition-colors border-2 border-[#2C2C2C]"
